function [cout,hout] = tricontour(t,p,Hn,N)
...
%       tri = delaunay(x,y);
%       z = peaks(15);
%       [c,h]=tricontour(tri,[x(:) y(:)],z(:),5);
%       clabel(c,h,'fontsize',15,'color','k','rotation',0);
%       view(2);
%
%  Type "contourdemo" for some more examples.
%
...
%
% If your going to use this inside a loop with the same [t,p] a good
...
% Updated 15/05/2006
% Updated 02/02/2012  ---Wen Long, PNNL wen.long@pnnl.gov
%
