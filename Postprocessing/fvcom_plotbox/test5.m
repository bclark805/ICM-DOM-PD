...
%     end
     ...
     %debug setting
     testcase_number =21  ; %1 to 16 for 16 idealized sanity test cases, 0 to turn off testing 
    ...
    for nf=his_fn_start:his_fn_int:his_fn_end
	      ...
	      par7=[]; 
			...
			if(testcase_number==8)
				...
				%
				%results:  mean(cflow_all) = -245.599472119753
...
%
			...
			%         mean(tflux_all)=57500 psum^3/sec   !Good
                        %
