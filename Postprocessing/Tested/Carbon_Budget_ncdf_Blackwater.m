...
load('/data/users/bclark/CBAY_DATA/Blackwater_Data/Blackwater_Discharge_2016.mat');
...
load('/data/users/bclark/CBAY_DATA/Blackwater_Data/Blackwater_WQ_River_2016.mat');
...
marsh_data=importdata('/data/users/bclark/CBAY_DATA/Blackwater_Data/seddom_grid.dat');
% load the grid file
...
% load(grid_file);
load('/data/users/bclark/CBAY_DATA/Blackwater_Data/Blackwater_grid_v4_7.mat');
...
[node_area]=importdata('/data/users/bclark/CBAY_DATA/Blackwater_Data/BW_node_area.mat');
...
node_area=BWnodearea;
marsh.nodes= find(marsh_data(:,3)>0);
marsh.area=node_area(marsh.nodes);
...
estuary.nodes=1:length(lld_n);
estuary.area=node_area(estuary.nodes);
% get the nodes
...
estuary.areaonly=node_area(estuary.nodesonly);
...
mydischarge=Blackwater_hourly_discharge;
river_time=(1:length(mydischarge));
...
Final_RR_forcing=Blackwater0000riv;
river.times=Final_RR_forcing(1:45:end,1)+first_day*24;
%
